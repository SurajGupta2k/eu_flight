...
EU Flight Monitor is a Flask-based API that collects, stores, and provides real-time flight information from European airports. The system is designed to help identify flights delayed by more th# EU Flight Monitor
...
3. Add the following variables:
   ```
   MYSQL_USER=sql12768976
   MYSQL_PASSWORD=7xSBSPA9Xl
   MYSQL_HOST=sql12.freesqldatabase.com
   MYSQL_DATABASE=sql12768976
...
## 👥 Contributors
- [Suraj Gupta](https://github.com/surajgupta101) - Initial work and developmentan 2 hours, assisting passengers in filing compensation claims under EU regulations.
